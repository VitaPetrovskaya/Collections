...
public class Order
{
    ...
    public IEnumerable<OrderItem> AddRange(IEnumerable<OrderItem> orderItems)
    {
...
public class Program
{
    public static void Main()
    {
        ...
        order.AddRange(new List<OrderItem>() {
        ...
        // TODO Replace with code that searches a list item in order.OrderItems.
        ...
        // TODO Replace with code that searches a list item in order.OrderItems.
        if (order.Find(x => x.PartNumber == 127700026) != null)
        {
            // TODO Calculate an order item price, and write it to the console using the same format as in Display method.
            Console.WriteLine("Order #2 has #127700026 item - price is {0:###,###.00}$.", order.Find(x => x.PartNumber == 127700026).UnitPrice);
        }
